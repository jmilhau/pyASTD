...
class qSynch(ASTD):
    """An qsynch ASTD class"""    
    _t = "qsyn"
        
    def __init__(self, b, x, t newname="" ) :
        """ Constructor for a qsynch ASTD
        b -- astd that is the operand of the qsynch ASTD (mandatory)
        x -- qsynch variable (mandatory)
        t -- values of x (mandatory)
    ...
    def getInit(self) :
        ...
        #TODO : ajouter l'ensemble de quantification
        return r
